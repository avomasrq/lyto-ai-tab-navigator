    ...
    <div className="min-h-screen bg-background">
      <div className="container max-w-3xl py-16 px-4">
        ...
        <div className="prose prose-invert max-w-none space-y-10 text-muted-foreground">
          ...
          <p>
            This Privacy Policy describes how the Argos browser extension ("Argos", "we", "us", or "our")
            collects, uses, stores, shares, and protects your information. Argos is an AI-powered research
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-3">
              ...
              <li>
                <strong>Transient Page Context:</strong> When you explicitly request Argos to perform a task on an active tab,
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              <a href="mailto:info@tryargos.cc" className="text-primary hover:underline underline-offset-4">info@tryargos.cc</a>.
          ...
          <section className="space-y-4">
            ...
            <p>
              Argos is not directed at children under the age of 13. We do not knowingly collect personal data
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              Continued use of Argos after changes means you accept the updated policy.
            </p>
          </section>
