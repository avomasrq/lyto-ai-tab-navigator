            ...
            <div className="w-full max-w-6xl">
                <div className="bento-grid">
                    ...
                    <BentoItem>
                        ...
                        <h3 className="text-2xl font-serif mb-2">Connects your tools</h3>
                    ...
                    <BentoItem>
                        ...
                        <h3 className="text-2xl font-serif mb-2">Your data stays local</h3>
                        <p className="text-base text-muted-foreground leading-relaxed">
                    ...
                    <BentoItem className="row-span-2">
                        ...
                        <h3 className="text-2xl font-serif mb-2">Research anything</h3>
                        <p className="text-base text-muted-foreground leading-relaxed">
                        ...
                        <div className="mt-5 space-y-2">
                            <div className="flex items-center gap-2 rounded-lg border border-border bg-muted/30 px-3 py-2.5">
                                ...
                                <span className="text-sm text-muted-foreground">Compare SaaS pricing across tabs</span>
                            </div>
                            {[
                    ...
                    <BentoItem>
                        ...
                        <h3 className="text-2xl font-serif mb-2">One-click install</h3>
                        <p className="text-base text-muted-foreground leading-relaxed">
                            Add to Chrome and start automating in seconds.
                        </p>
                        <div className="mt-5 rounded-lg border border-border bg-muted/30 px-3 py-2.5 text-sm text-muted-foreground leading-relaxed">
                            ✓ Free to install · Google account required
                        </div>
                    </BentoItem>
