      ...
      <AnimatePresence>
        ...
        >
          <motion.div
            ...
            variants={upgradeBannerVariants}
            custom={{ x: -10, y: -10 }}
            className="pointer-events-none absolute left-[4px] top-[2px]"
          >
            <SettingsFilled className="text-[#005FF2]" />
          </motion.div>
          <motion.div
            initial="hidden"
            animate={isHovered ? "visible" : "hidden"}
          ...
          <div className="relative flex h-[35px] items-center gap-1 rounded-[6px] border border-[#CBE7FF] bg-[#F0F7FF] pl-2.5 pr-1 text-sm">
            <button
              className="cursor-pointer border-none bg-transparent px-0 py-1 font-sans text-[13px] font-medium text-[#002359] underline decoration-[#CAE7FF] underline-offset-[5px] outline-none hover:text-[#005FF2] hover:decoration-[#94CCFF] transition-colors duration-150"
            ...
            <span className="text-[0.8125rem] text-[#005FF2]">
              {description}
            </span>
            {onClose && (
              <button
                onClick={onClose}
                className="ml-1 flex h-6 w-6 shrink-0 cursor-pointer items-center justify-center rounded-[4px] border-0 bg-transparent p-0 text-[#005FF2] hover:bg-[#CAE7FF] transition-colors"
              >
                <X size={14} className="text-[#005FF2]" />
              </button>
            )}
          </div>
        </motion.div>
